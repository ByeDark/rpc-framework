...
### 自定义协议的通信包格式如下
![图片](https://github.com/byedark/rpc-framework/assets/77144511/e881f71a-a78b-4757-8a8b-6ff1520c5adb)
...
4、动态代理：RPC 的主要目的就是让我们调用远程方法像调用本地方法一样简单，使用动态代理可以屏蔽远程方法调用的细节比如网络传输。
